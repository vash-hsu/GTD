...
* following steps on "Building Your First Web API with ASP.NET Core MVC and Visual Studio"
...
##### send Request by GET for specific id
```
...
#### Update
##### send Request by PATCH, to update partial
```
...
#### Delete
#### send Request by DELETE, to purge partical id
```
